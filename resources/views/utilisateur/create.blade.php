    ...
    <form action="{{ route('livre.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <input type="text" name="PublisherYear" class="form-control" placeholder="Publish Year" required>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-4">
                        ...
                        <input type="text" name="fournisseur_id" class="form-control" placeholder="Fournisseur" required>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 mt-4">

...
<body>
    ...
    <div class="pull-right">
        <a class="btn btn-success" href="{{route('personnel.create')}}"> Add New Staff</a>
    </div>
...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>
            <form action="{{ route('personnel.destroy',$staff->id) }}" method="GET">


                <a class="btn btn-primary" href="{{ route('personnel.edit',$staff->id) }}">Edit</a>

<head>
    ...
    <div class=" container row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('personnel.index') }}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('personnel.update',$staff->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class=" container row">
               <div class="col-xs-12 col-sm-12 col-md-10 mt-2">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 mt-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="Gender" value="{{ $staff->Gender }}" class="form-control" required>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-10 mt-2">
                    <div class="form-group">
                        <strong>Birth Date:</strong>
                        <input type="text" name="BirthDate" value="{{ $staff->BirthDate }}" class="form-control" required>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-10 mt-2">
                    <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 mt-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="Address" value="{{ $staff->Address }}" class="form-control" required>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-10 mt-2">
                    <div class="form-group">
